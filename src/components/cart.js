    ...
    return (
      <div className="empty-cart-container">
        <div className="empty-cart">
          <img src={emptyCart} title="empty cart icons" width="100" height="100" className="empty-cart-img"/>
        </div>
        <h2>I&apos;M EMPTY :-( PLEASE ADD PRODUCTS.</h2>
        <button id="back-to-purchase" type="submit" className="button" onClick={handleBackToPurchase}>
          Continue Shopping
        </button>
      </div>
    );
